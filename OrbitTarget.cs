...
public class OrbitTarget : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        var newRotationDir = new Vector3(Mathf.Cos(newRotationRads), 0f, Mathf.Sin(newRotationRads));
        transform.position = _target.position + newRotationDir.normalized*newDistance + Vector3.up*newHeight;
